<template>
  <div class="grid">
    <section class="hero-board assistant-hero">
      <div class="hero-main">
        <h2>对话助手</h2>
        <p class="hero-subtitle">通过自然语言触发异常汇总、处置建议和报告生成，并展示处理过程。</p>
      </div>
    </section>
    ...
    <section class="panel assistant-box">
      ...
      <div style="display: flex; gap: 8px; flex-wrap: wrap">
        ...
        <el-button @click="message = '汇总今天异常情况'">异常汇总</el-button>
        <el-button @click="message = '给出处置建议'">处置建议</el-button>
        <el-button @click="message = '生成今日日报'">生成日报</el-button>
      </div>
    </section>
...
function stepDetail(step: string) {
  const details: Record<string, string> = {
    understand_task: "识别用户任务目标、时间范围和输出类型",
