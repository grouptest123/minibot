  ...
  <div class="events-grid">
    <section class="panel">
      <div class="section-title">
        <h3>事件工作台</h3>
        <span class="section-caption">Event Console</span>
      </div>
    ...
    <template v-if="selected">
      ...
      <section class="panel">
        <div class="section-title">
          <h3>研判流程</h3>
          <span class="section-caption">Process Flow</span>
        </div>
      ...
      <section class="panel">
        <div class="section-title">
          <h3>多模态融合时间轴</h3>
          <span class="section-caption">Fusion Timeline</span>
        </div>
      ...
      <section class="panel">
        <div class="section-title">
          <h3>信号强度</h3>
          <span class="section-caption">Signal Strength</span>
        </div>
      ...
      <section class="panel">
        <div class="section-title">
          <h3>问题关键帧</h3>
          <span class="section-caption">Video Traceback</span>
        </div>
      ...
      <section class="panel">
        <div class="section-title">
          <h3>知识与案例命中</h3>
          <span class="section-caption">Retrieved Context</span>
        </div>
      ...
      <section class="panel">
        <div class="section-title">
          <h3>处置建议</h3>
          <span class="section-caption">Decision Output</span>
        </div>
